            ...
            @for (alert of alerts; track alert.id) {
              <div class="alert-item">
                <div
                  ...
                  [classList]="'alert-indicator ' + alert.indicatorType"
                ></div>
              ...
              @for (order of recentOrders; track order.id) {
                <tr>
                  ...
                  <td>
                    <span
                      class="status-badge"
                      [classList]="'status-badge ' + getStatusClass(order.status)"
                    >
                      {{ order.status }}
                    </span>
                  </td>
...
export class DashboardComponent implements OnInit {
  ...
  quickActions = [
    {
      ...
      icon: '<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg>',
      typeClass: 'type-blue',
    },
    {
      title: 'Create Order',
      subtitle: 'New test entry',
      icon: '<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><line x1="9" y1="15" x2="15" y2="15"/></svg>',
      typeClass: 'type-emerald',
    },
    {
      title: 'Enter Results',
      subtitle: 'Update findings',
      icon: '<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m11 17 2 2a1 1 0 1 0 3-3"/><path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4"/><path d="m21 3-6 6"/><path d="M3 21l6-6"/></svg>',
      typeClass: 'type-purple',
    },
    {
      title: 'Generate Report',
      subtitle: 'Export data',
      icon: '<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>',
      typeClass: 'type-rose',
    },
  ];
  ...
  alerts = [
    {
      ...
      description: 'Patient "Raj K." HbA1c is 11.2%',
      time: '10 mins ago',
      actionText: 'Review now',
      indicatorType: 'indicator-red',
    },
    {
      id: 2,
      title: 'Pending Reports',
      description: '12 reports from yesterday are still pending review.',
      time: '1 hour ago',
      actionText: 'View pending',
      indicatorType: 'indicator-amber',
    },
    {
      id: 3,
      title: 'Low Inventory',
      description: 'Glucose strips are running low (2 days supply left).',
      time: '3 hours ago',
      actionText: 'Order stock',
      indicatorType: 'indicator-orange',
    },
    {
      id: 4,
      title: 'Equipment Maintenance',
      description: 'Centrifuge machine 2 requires monthly service.',
      time: 'Yesterday',
      actionText: 'Schedule',
      indicatorType: 'indicator-blue',
    },
  ];
  ...
  ngOnInit(): void {
    const isTempPassword = localStorage.getItem('is-temp-password') === 'true';
    const alertShown = sessionStorage.getItem('temp-password-alert-shown');

    if (isTempPassword && !alertShown) {
      sessionStorage.setItem('temp-password-alert-shown', 'true');
      ...
      const dialogRef = this.dialog.open(ConfirmationPopupComponent, {
        ...
        data: {
          ...
          message: `You are using temporary password. Please change your password cause of the security threat. Go to profile and change your password.`,
          type: 'warn',
          confirmText: 'Change',
        },
      });
